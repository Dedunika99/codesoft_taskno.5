...
public class Selection extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Select the type you want to register");

        jRadioButton1.setForeground(new java.awt.Color(0, 51, 153));
        jRadioButton1.setText("Student Registration");

        jRadioButton2.setForeground(new java.awt.Color(0, 51, 153));
        jRadioButton2.setText("Course Registration");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       if (jRadioButton1.isSelected()){
           ...
           JOptionPane.showMessageDialog(this, "Select the type you want to register");
           Selection s=new Selection();
           s.setVisible(true);
       }
